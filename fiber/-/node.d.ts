...
declare namespace $ {
    ...
    function $mol_fiber_func<Calculate extends (this: This, ...args: any[]) => Value, Value = void, This = void>(calculate: Calculate): Calculate;
    function $mol_fiber_method<Host, Value>(obj: Host, name: string, descr: TypedPropertyDescriptor<(this: Host, ...args: any[]) => Value>): void;
